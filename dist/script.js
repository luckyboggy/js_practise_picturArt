...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var triggerDestroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  showModalByTyme('.popup-consultation', 6000);
};
...
var slider = function slider(slidesSlelector, direction, prev, next) {
  var slides = document.querySelectorAll(slidesSlelector);
  var slideIndex = 1,
      paused = false;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_components_modals__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_components_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  Object(_components_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
});
